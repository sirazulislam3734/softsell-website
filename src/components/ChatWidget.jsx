...
function ChatWidget({ isOpen: propIsOpen, setIsOpen: propSetIsOpen }) {
  ...
  const [messages, setMessages] = useState([
    { id: 1, text: "Hello! How can I help you with software license resale today?", sender: "bot" }
  ])
  ...
  const botResponses = {
    "how do i sell my license?": "To sell your license, simply fill out the contact form with your license details. We'll send you a valuation within 24 hours, and if you accept, you'll get paid within 48 hours after verification!",
    "what licenses do you accept?": "We accept licenses from major enterprise software providers including Microsoft, Adobe, Oracle, SAP, Salesforce, Autodesk and many others. Both perpetual and subscription licenses can be resold.",
    "how long does the process take?": "Our process is fast! After submitting your license info, you'll receive a valuation within 24 hours. If you accept, payment is processed within 48 hours of license verification.",
    "how much is my license worth?": "License values vary based on software type, remaining term, and market demand. Enterprise solutions like SAP or Oracle typically fetch higher values. Submit your details for a free, no-obligation quote!",
  }
  ...
  const handleSendMessage = (e) => {
    ...
    setTimeout(() => {
      ...
      if (!responseText) {
        responseText = "Thanks for your question! To get specific information about your software licenses, please fill out our contact form and one of our specialists will assist you shortly."
      }
      
      const botMessage = { id: messages.length + 2, text: responseText, sender: "bot" }
